    ...
    <div className="min-h-[100dvh] bg-[#f5f5f7] text-[#1d1d1f] flex flex-col font-sans">
      ...
      <section className="py-20 px-4 border-t border-[#e5e5e7] bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <FeatureCard icon={<Zap className="w-5 h-5" />} title="Bring your own model" description="Ships with Claude, but any OpenAI-compatible local model works out of the box." />
        </div>
      </section>

      <footer className="py-8 text-center text-[#86868b] text-sm border-t border-[#e5e5e7] bg-white">
        <p data-testid="text-footer">EasyBoard &nbsp;·&nbsp; MIT License</p>
      </footer>
    </div>
  );
}
