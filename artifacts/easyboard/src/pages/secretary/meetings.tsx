...
export default function SecretaryMeetings() {
  ...
  const handleCreate = () => {
    ...
    createMeeting.mutate({ data: { ...form, date: new Date(form.date).toISOString() } }, {
      onSuccess: () => {
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select value={form.boardId} onChange={(e) => setForm({ ...form, boardId: e.target.value })}
                    className="w-full px-3 py-2.5 bg-[#f5f5f7] rounded-xl text-sm border-0 focus:outline-none focus:ring-2 focus:ring-[#0071e3]/30" data-testid="select-meeting-board">
                ...
                <div>
                  ...
                  <input type="datetime-local" value={form.date} onChange={(e) => setForm({ ...form, date: e.target.value })}
                    className="w-full px-3 py-2.5 bg-[#f5f5f7] rounded-xl text-sm border-0 focus:outline-none focus:ring-2 focus:ring-[#0071e3]/30" data-testid="input-meeting-date" />
                </div>
              </div>
              <div>
                ...
                <input value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })}
                  ...
                  className="w-full px-3 py-2.5 bg-[#f5f5f7] rounded-xl text-sm border-0 focus:outline-none focus:ring-2 focus:ring-[#0071e3]/30" data-testid="input-meeting-title" />
              </div>
              <div>
                ...
                <input value={form.location} onChange={(e) => setForm({ ...form, location: e.target.value })}
                  ...
                  className="w-full px-3 py-2.5 bg-[#f5f5f7] rounded-xl text-sm border-0 focus:outline-none focus:ring-2 focus:ring-[#0071e3]/30" data-testid="input-meeting-location" />
              </div>
